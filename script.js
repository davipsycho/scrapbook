...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "....." },
        { time: 2, text: "I Just Wanna See" },
        { time: 3, text: "I Just Wanna See How" },
        { time: 7, text: "Beutiful you are" },
        { time: 10, text: "You Know That I See It" },
        { time: 13, text: "I Know You're A Star" },
        { time: 16, text: "Where You Go I'il Follow" },
        { time: 20, text: "No Mattar How Far" },
        { time: 23, text: "If Life Is A Movie" },
        { time: 26, text: "Oh, You're The Best Part, Oh...ooh" },
        { time: 40, text: "Best Part" },
        { time: 43, text: "It Is Sunrise" },
        { time: 46, text: "And Those Brown Eyes Yes" },
        { time: 49, text: "You're That One That I Desire " },
        { time: 55, text: "When We Wake Up" },
        { time: 59, text: "....." },
    ];
